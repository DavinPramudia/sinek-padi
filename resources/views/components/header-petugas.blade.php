{{-- Perhatikan tambahan /80 dan backdrop-blur-md di bawah ini --}}
<nav class="bg-[#0B0909]/50 backdrop-blur-md border-b border-[#EDEDED] py-1 px-6 flex justify-between items-center sticky top-0 z-50">
