        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-xs divide-y divide-[#3b5952]/40">
                ...
                <tr class="hover:bg-[#1c2b28]/60 transition duration-150">
                    <td class="py-3.5 pl-2 font-mono text-[#EDEDED] font-semibold">KRC260712-0001</td>
                    <td class="py-3.5 text-[#d1d5dc]">26/07/2026, 15:30 WIB</td>
                    <td class="py-3.5">
                    ...
                    <td class="py-3.5 font-bold text-[#3aafa9] text-sm">Rp 12.000</td>
                    <td class="py-3.5 text-center">
                        <button type="button" class="border border-[#3aafa9] text-[#3aafa9] hover:bg-[#3aafa9] hover:text-[#0B0909] text-[10px] font-bold py-1.5 px-3 rounded-xl transition duration-150 flex items-center justify-center space-x-1.5 mx-auto active:scale-95 cursor-pointer">
                ...
                {{-- Baris Data 2 --}}
                <tr class="hover:bg-[#1c2b28]/60 transition duration-150">
                    <td class="py-3.5 pl-2 font-mono text-[#EDEDED] font-semibold">KRC260712-0002</td>
                    <td class="py-3.5 text-[#d1d5dc]">26/07/2026, 15:35 WIB</td>
                    <td class="py-3.5">
                        <span class="bg-[#243733] text-[#d1d5dc] px-2.5 py-1 rounded-md text-[11px] border border-[#3b5952]">
                            Mobil
                        </span>
                    ...
                    <td class="py-3.5 font-bold text-[#3aafa9] text-sm">Rp 40.000</td>
                    <td class="py-3.5 text-center">
                        <button type="button" class="border border-[#3aafa9] text-[#3aafa9] hover:bg-[#3aafa9] hover:text-[#0B0909] text-[10px] font-bold py-1.5 px-3 rounded-xl transition duration-150 flex items-center justify-center space-x-1.5 mx-auto active:scale-95 cursor-pointer">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 000-4H9a2 2 0 000 4zm8-12V5a2 2 0 00-2-2H7a2 2 0 00-2 2v4h14z"></path>
